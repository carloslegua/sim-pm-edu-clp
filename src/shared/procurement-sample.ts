...
// (Proveedor A, B y C, Subcontrata MEP), las fechas requeridas son las del CRONOGRAMA CPM del caso (3.1 en obra 2026-10-15; 3.2 cierra la Procura
// 2026-11-02; 3.3 2026-10-09; 4.5 termina 2027-04-14; 4.1 arranca 2026-11-10), los riesgos que un contrato debe tratar son los del Registro (R-02 acero,
...
// calidad (95.000). La fecha de corte es la aprobación del plan (2026-08-03, paquete 1.2): a esa fecha ninguna convocatoria está vencida.
...
export const SAMPLE_AS_OF = "2026-08-03";
...
const ROWS: Row[] = [
  ["PR-01", "Estructuras metálicas prefabricadas", ["3.1"], true, "Comprar", "Precio fijo con ajuste económico (FPEPA)", "Concurso por calidad y costo", CRITERIA(35, 35, 20, 10), 1820000, "2026-10-15", 16, 45, "Proveedor A", "Convocada", "Jefe de Logística", ["R-02", "R-04", "R-08"]],
  ["PR-02", "Materiales de construcción", ["3.2"], true, "Comprar", "Precio unitario", "Concurso de precios", CRITERIA(50, 20, 20, 10), 715000, "2026-11-02", 20, 30, "Proveedor B", "Planificada", "Jefe de Logística", ["R-10"]],
  ["PR-03", "Equipos eléctricos e instalaciones", ["3.3"], true, "Comprar", "Precio fijo (FFP)", "Invitación restringida", CRITERIA(40, 30, 20, 10), 415000, "2026-10-09", 11, 20, "Proveedor C", "Planificada", "Jefe de Logística", ["R-04", "R-10"]],
  ["PR-04", "Subcontrato de instalaciones MEP", ["4.5"], true, "Comprar", "Precio fijo (FFP)", "Invitación restringida", CRITERIA(40, 30, 10, 20), 485000, "2027-04-14", 48, 60, "Subcontrata MEP", "Planificada", "Director de Proyecto", []],
  ["PR-05", "Servicio de ensayos de laboratorio (suelos, concreto y densidad de campo)", ["4.1", "4.2"], false, "Comprar", "Precio unitario", "Concurso de precios", CRITERIA(50, 30, 10, 10), 95000, "2026-11-10", 10, 30, "", "Planificada", "Control de Calidad", ["R-05", "R-06", "R-07"]]
];
